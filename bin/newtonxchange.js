...
const { ExchangeError, ArgumentsRequired, ExchangeNotAvailable, AuthenticationError, InvalidOrder, InvalidAddress, InsufficientFunds, OrderNotFound, PermissionDenied } = require ('ccxt/js/base/errors');

//  ---------------------------------------------------------------------------

module.exports = class newtonxchange extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'api': 'https://openapi.newtonxchange.pro/open/api',
